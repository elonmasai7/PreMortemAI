...
def summarize(payload: EvidencePayload, ai_provider=Depends(get_ai_provider)):
    return ai_provider.summarize_evidence(payload.evidence)


@router.post("/root-cause")
def root_cause(payload: EvidencePayload, ai_provider=Depends(get_ai_provider)):
    return ai_provider.rank_root_causes(payload.evidence)


@router.post("/remediation-plan")
def remediation_plan(payload: EvidencePayload, ai_provider=Depends(get_ai_provider)):
    return ai_provider.create_remediation_plan(payload.evidence)


@router.post("/postmortem")
def postmortem(payload: PostmortemPayload, ai_provider=Depends(get_ai_provider)):
